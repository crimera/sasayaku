...
class VideoTranscriber:
    def __init__(self, model_path: str):
        ...
        self.vttfilename: str = None
        self.outputfilename: str = None
        self.model_path: str = model_path

    def transcribeAndEmbded(self, url):
        ...
        if (isytdlpsupported == 256):
            ...
            self.filename = urllib.parse.unquote(os.path.basename(effective_url))
            self.vttfilename = f"{self.filename}.srt"
            self.outputfilename = f"{self.filename}.mp4"
        ...
        vttfilename = f"{self.vttfilename}"
        outputfilename = f"{self.outputfilename}"
